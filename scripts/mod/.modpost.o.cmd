cmd_scripts/mod/modpost.o := ccache gcc -Wp,-MD,scripts/mod/.modpost.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O3 -fomit-frame-pointer -fgcse-las     -c -o scripts/mod/modpost.o scripts/mod/modpost.c
